...
If[ClusterRun,SetDirectory["./"],SetDirectory[NotebookDirectory[]](*SetDirectory["D:\\Dropbox\\Projects\\Zika vaccine"]*)];
...
(*To update*)
(*\[Gamma]\[Rule]365/4.5(*Lucey*)(*-Log[1-1/5]*)(*I\[Rule]R*),
v\[Delta]\[Rule]126.5(*11 days from Chao dengue review*)(*365/7*)(*-Log[1-1/5] *)(*Mosquito E\[Rule]I*),
\[Beta]fm\[Rule]0.1(*Female\[Rule]male transmission*),
c\[Rule]0.65*365(*Biting rate*),*)
\[Gamma]->365/5.5,
v\[Delta]->365/11,
\[Beta]fm->0,
c->0.63*365,
...
seasonalityAmplitude->4/5,
seasonalityPhase->Pi/4
}},
Join[
mostpars,
(*Mosquito birth rate computed to hold at carrying capacity *)
{\[Beta]vh->1.1 betaHV,
(*MosqBirth\[Rule](v\[Mu]/.mostpars)*mosquitoPopulation[country]*(1-1/3*Cos[t*2*Pi])*)
